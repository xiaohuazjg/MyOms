...
class NetworkDev(models.Model):
    ...
    netdev_procurement_date = models.DateField(default=django.utils.timezone.now, verbose_name="采购时间",
                                               help_text="采购时间")
    netdev_boarding_date = models.DateField(default=django.utils.timezone.now, verbose_name="上架日期",
                                            help_text="上架日期")
    ...
    netdev_state = models.CharField(max_length=32, choices=tuple(Netdev_State.items()), verbose_name="状态",
                                    help_text="状态")
    ...
    netdev_type = models.CharField(max_length=32, choices=tuple(Netdev_Types.items()), verbose_name="设备类型",
                                   help_text="设备类型")
    ...
    netdev_qr = models.CharField(max_length=64, verbose_name="QR码 ", help_text="QR码 ", null=True,
                                       blank=True)
